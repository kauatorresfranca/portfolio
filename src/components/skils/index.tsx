  ...
  return (
    ...
    <S.Background id="skils">
      <div className="container">
        <h3>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={colors.detach} className="bi bi-diamond" viewBox="0 0 16 16">
        ...
        <div>
          <S.SkilArea className="front">
            <S.Acordeon onClick={() => { setFrontIsOpen(!frontIsOpen) }}>
              <S.AreaLeft>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={colors.detach} className="bi bi-code-slash" viewBox="0 0 16 16">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={colors.detach} className={frontIsOpen ? 'bi bi-chevron-compact-down open' : 'bi bi-chevron-compact-down'} viewBox="0 0 16 16">
          ...
          <S.SkilArea className="back">
            <S.Acordeon onClick={() => { setBackIsOpen(!backIsOpen) }}>
              <S.AreaLeft>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={colors.detach} className="bi bi-database" viewBox="0 0 16 16">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={colors.detach} className={backIsOpen ? 'bi bi-chevron-compact-down open' : 'bi bi-chevron-compact-down'} viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M1.553 6.776a.5.5 0 0 1 .67-.223L8 9.44l5.776-2.888a.5.5 0 1 1 .448.894l-6 3a.5.5 0 0 1-.448 0l-6-3a.5.5 0 0 1-.223-.67" />
              </svg>
            </S.Acordeon>
          ...
          <S.SkilArea className="tools">
            <S.Acordeon onClick={() => { setToolsIsOpen(!toolsIsOpen) }}>
              <S.AreaLeft>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={colors.detach} className="bi bi-tools" viewBox="0 0 16 16">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={colors.detach} className={toolsIsOpen ? 'bi bi-chevron-compact-down open' : 'bi bi-chevron-compact-down'} viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M1.553 6.776a.5.5 0 0 1 .67-.223L8 9.44l5.776-2.888a.5.5 0 1 1 .448.894l-6 3a.5.5 0 0 1-.448 0l-6-3a.5.5 0 0 1-.223-.67" />
              </svg>
            </S.Acordeon>
