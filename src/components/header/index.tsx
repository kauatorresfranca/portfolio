        ...
        <S.Header>
            ...
            <S.ToggleTheme themeName={theme} onClick={toggleTheme}>
              <div className='ball'>{theme === "dark" ?
                ...
                (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2a3342" className="bi bi-moon-stars-fill" viewBox="0 0 16 16">
                ...
                (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff" className="bi bi-sun-fill" viewBox="0 0 16 16">
