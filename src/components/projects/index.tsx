    ...
    <>
      <div id="projects" className="container">
        <S.Container>
          ...
          <S.ProjectList>
            <Project imgUrl='/E_play.png' gitHubUrl='https://github.com/kauatorresfranca/site-game-eplay' projectViewUrl='https://site-game-eplay.vercel.app/' title='E-PLAY' description='o site consiste em um e-comerce de jogos'>
              <>
            ...
            <Project imgUrl='/E_food.png' gitHubUrl='https://github.com/kauatorresfranca/Efood' projectViewUrl='https://efood-rouge-six.vercel.app/' title='E-FOOD' description='dsadasdadas'>
              <>
                <Tag tagType='react'>react</Tag>
                <Tag tagType='ts'>ts</Tag>
                <Tag tagType='js'>js</Tag>
            ...
            <Project imgUrl='/to_do.png' gitHubUrl='https://github.com/kauatorresfranca/to-do' projectViewUrl='https://to-do-seven-steel.vercel.app/' title='TO-DO LIST' description='dsadasdadas'>
              <>
                <Tag tagType='react'>react</Tag>
                <Tag tagType='ts'>ts</Tag>
                <Tag tagType='js'>js</Tag>
